...
with_node \
  ...
  --target "/Users/user1/Documents/Proyectos/Nutribox/ios/Pods/Target Support Files/Pods-Nutribox/ExpoModulesProvider.swift" \
  --entitlement "/Users/user1/Documents/Proyectos/Nutribox/ios/Nutribox/Nutribox.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-image-picker" "expo-keep-awake"
